                ...
                foreach ($alunos as $item) {
                    ...
                    <td>
                        <span class='badge rounded-pill bg-primary'>
                            <a href='?pagina=alunos&acao=editar&codigo={$item->getCodigo()}' style='color:#fff'><i class='bi bi-pencil-square'></i></a>
                        </span>
                        <span class='badge rounded-pill bg-danger'>
                            <a href='?pagina=alunos&acao=excluir&codigo={$item->getCodigo()}'style='color:#fff'><i class='bi bi-trash'></i></a>
                        </span>
                    </td>
                    </tr>";
                }
